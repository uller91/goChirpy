...
SELECT users.id, users.created_at, users.updated_at, users.email, users.hashed_password, refresh_tokens.expires_at as token_expires_at, refresh_tokens.revoked_at as token_revoked_at from users
